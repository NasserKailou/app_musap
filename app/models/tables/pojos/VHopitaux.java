...
public class VHopitaux implements Serializable {

    private static final long serialVersionUID = 1438730667;
    ...
    public VHopitaux(VHopitaux value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VHopitaux (");
