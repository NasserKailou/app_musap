...
public class VRegBonCommande implements Serializable {

    private static final long serialVersionUID = 903471334;
    ...
    public VRegBonCommande(VRegBonCommande value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VRegBonCommande (");
