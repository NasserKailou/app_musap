...
public class VRegPriseEnCharge implements Serializable {

    private static final long serialVersionUID = 851425648;
    ...
    public VRegPriseEnCharge(VRegPriseEnCharge value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VRegPriseEnCharge (");
