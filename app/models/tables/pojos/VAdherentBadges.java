...
public class VAdherentBadges implements Serializable {

    private static final long serialVersionUID = 941315995;
    ...
    public VAdherentBadges(VAdherentBadges value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VAdherentBadges (");
