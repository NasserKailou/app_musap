...
public class UsersDao extends DAOImpl<UsersRecord, models.tables.pojos.Users, Long> {
     ...
     */
    @Override
    protected Long getId(models.tables.pojos.Users object) {
        return object.getId();
    }
     ...
     */
    public List<models.tables.pojos.Users> fetchById(Long... values) {
     ...
     */
    public models.tables.pojos.Users fetchOneById(Long value) {
    ...
    /**
     * Fetch records that have <code>connect_first IN (values)</code>
     */
    public List<models.tables.pojos.Users> fetchByConnectFirst(Boolean... values) {
        return fetch(Users.USERS.CONNECT_FIRST, values);
    }
