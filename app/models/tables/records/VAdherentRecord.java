...
public class VAdherentRecord extends TableRecordImpl<VAdherentRecord> {
    ...
    private static final long serialVersionUID = -1321240997;
    ...
    /**
     * Setter for <code>public.v_adherent.is_member</code>.
     */
    ...
    /**
     * Getter for <code>public.v_adherent.is_member</code>.
     */
    ...
    /**
     * Setter for <code>public.v_adherent.email</code>.
     */
    ...
    /**
     * Getter for <code>public.v_adherent.email</code>.
     */
     ...
     */
    public VAdherentRecord(Long id, String nomAd, String prenomAd, String sexe, String matricule, String codeCarnet, String categorie, String fonction, String structureSigle, Timestamp dateNaiss, Integer age, Timestamp datePriseService, Integer anciennete, Long salaireNet, Double pourcentageTotalRetenue, Boolean isMember, String email, Double totalCotisationAgent, Double totalCreditAnnuelle, Double totalCreditAConsomer, BigDecimal montantTotalBrute, BigDecimal montantReglementCouvert, BigDecimal montantPayer, String picture, Timestamp whenDone, String whoDone, Boolean onDeleted, String direction, String division, String service, String telephone) {
        super(VAdherent.V_ADHERENT);
        ...
        set(15, isMember);
        set(16, email);
        set(17, totalCotisationAgent);
        set(18, totalCreditAnnuelle);
        set(19, totalCreditAConsomer);
        set(20, montantTotalBrute);
        set(21, montantReglementCouvert);
        set(22, montantPayer);
        set(23, picture);
        set(24, whenDone);
        set(25, whoDone);
