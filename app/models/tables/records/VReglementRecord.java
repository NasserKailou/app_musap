...
public class VReglementRecord extends TableRecordImpl<VReglementRecord> {
    ...
    private static final long serialVersionUID = 1246323156;
    ...
    /**
     * Setter for <code>public.v_reglement.is_remboursement</code>.
     */
    ...
    /**
     * Getter for <code>public.v_reglement.is_remboursement</code>.
     */
     ...
     */
    public VReglementRecord(Long id, String nomAd, String prenomAd, Long idAdherent, String matricule, Long salaireNet, String codeCarnet, String telephone, Double pourcentageTotalRetenue, String refFacture, Long idStruc, String structure, Timestamp datePayement, String whoDone, Timestamp whenDone, Boolean isConfirmedBon, Boolean isRemboursement, Timestamp whenConfirmedBon, Timestamp dateExpiration, String typeReglement, String annee, Boolean onDeleted, Long idPrestation, String prestation, String couverture, String tauxPublic, String tauxPrive, String typeStructure, String statutStructure, String nomAy, String lien, String genre, Long ayantDroit, Long montantTotal, String tauxCouvertureEffectif, Long montantReglement, Long montantPaye, Long idStructure) {
        super(VReglement.V_REGLEMENT);
        ...
        set(16, isRemboursement);
        set(17, whenConfirmedBon);
        set(18, dateExpiration);
        set(19, typeReglement);
        set(20, annee);
        set(21, onDeleted);
        set(22, idPrestation);
        set(23, prestation);
        ...
        set(25, tauxPublic);
        set(26, tauxPrive);
        set(27, typeStructure);
        set(28, statutStructure);
        set(29, nomAy);
        set(30, lien);
        set(31, genre);
        set(32, ayantDroit);
        set(33, montantTotal);
        set(34, tauxCouvertureEffectif);
        set(35, montantReglement);
        set(36, montantPaye);
        set(37, idStructure);
    }
}
